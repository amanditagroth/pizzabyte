...
<form method="POST" action="cad.php">
    <div>
        ...
        <input type="text" name="field_nome" size="50" maxlength="50" id="id_nome" autofocus autocomplete="off">
    </div>
    <div>
        <label for="id_email">E-mail: </label>
        <input type="email" name="field_email" size="50" maxlength="50" placeholder="Informe o e-mail utilizado no cadastro" id="id_email">
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="field_endereco" size="50" maxlength="50" id="id_endereco" placeholder="Rua, número, complemento">
    </div>
    <div>
    ...
    <div>
        ...
        <textarea name="field_obs" rows="5" cols="50" placeholder="Informações adicionais" id="id_obs"></textarea>
    </div>
